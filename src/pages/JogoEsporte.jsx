                        ...
                        <div className="w-[70%] bg-zinc-300 rounded-xl overflow-hidden">
                            ...
                            <span className="flex justify-between items-center p-4">
                                <span className="flex justify-center items-center gap-3">
                                    <img src={time1.escudo} alt="" className="w-15 cursor-pointer" onClick={() => {navigate(`/detalhes/time?time=${time1.nome}`)}}/>
                                    <h1>{time1.nome}</h1>
                                </span>
                                <i className="fa-solid fa-xmark"></i>
                                <span className="flex justify-center items-center gap-3">
                                    <h1>{time2.nome}</h1>
                                    <img src={time2.escudo} alt="" className="w-15 cursor-pointer" onClick={() => {navigate(`/detalhes/time?time=${time2.nome}`)}}/>
                                </span>
                            </span>
                        </div>
