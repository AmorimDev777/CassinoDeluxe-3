...
function CardCassino({imgGame ,gameName ,location}) {
    return (
        <div className="flex flex-col relative">
            <div className="flex justify-center items-center relative bg-zinc-900 aspect-[2/1.3] 
            rounded-2xl overflow-hidden group"
            >
                <img src={imgGame} alt="" className="h-full w-full object-cover transition-all 
                duration-300 group-hover:scale-[1.4] group-hover:blur-xs"
                />
            ...
            <h1 className="absolute bottom-0 translate-y-full text-center text-lg text-white 
            xl:-bottom-2 2xl:text-3xl"
            >{gameName}</h1>
        </div>
    )
}
